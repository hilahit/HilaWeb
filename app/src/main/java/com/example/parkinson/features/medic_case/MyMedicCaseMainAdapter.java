...
public class MyMedicCaseMainAdapter extends MultiViewAdapter {

    MyMedicCaseMainAdapterListener listener;

    public interface MyMedicCaseMainAdapterListener extends MedicineBinderMedicine.MedicineBinderMedicineListener {
    }
